...
المساعدة الحقيقية تشمل أي حاجة من دول:
- إجابة مباشرة على سؤال
- شرح طريقة حل مسألة أو مشكلة
- تفسير أو توضيح معلومة مش واضحة
- مساعدة عادية (نصيحة مفيدة، توجيه صحيح، حل لمشكلة تقنية أو دراسية أو غيرها)
...
المساعدة الحقيقية تشمل: إجابة على سؤال، شرح طريقة حل، تفسير أو توضيح معلومة، أو مساعدة عادية واضحة (نصيحة مفيدة، حل مشكلة، توجيه صحيح).
...
قواعد:
- لو الرسالة كلام عادي، دردشة، رأي، تعليق، مجاملة، أو مالهاش قيمة معلوماتية واضحة -> isHelp: false
- لو الرسالة فعلاً بتشرح حاجة، بتجاوب على سؤال، بتوضح طريقة حل، أو بتقدم مساعدة حقيقية واضحة -> isHelp: true
