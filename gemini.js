...
المساعدة الحقيقية حاجة واحدة بس: **تفسير/شرح إجابة سؤال بشكل صحيح ومفهوم**. يعني الرد لازم يوضح "ليه" الإجابة كده أو "إزاي" نوصلها، مش مجرد الإجابة النهائية من غير شرح.

شروط لازم تتحقق كلها:
- فيه سؤال واضح في الرسالة الأولى
- الرد بيشرح/يفسر الإجابة (مش بس بيدي الإجابة النهائية زي حرف أو رقم من غير توضيح)
- الشرح صحيح فعلاً ومنطقي (لو الشرح غلط أو ناقص أو مش مفهوم -> isHelp: false)
- الشرح مش سطحي أو تافه (مش مجرد جملة عامة زي "لأنها كده" أو "معروف كده")

كن متشددًا جدًا جدًا. لما تشك، اختار isHelp: false. الهدف إننا مانديش نقاط إلا لحد فسّر إجابة سؤال بشكل صحيح وواضح وفاهم فعلاً.
...
قواعد صارمة:
1. لازم الرسالة الأولى تكون سؤال واضح محتاج إجابة. لو كلام عام، دردشة، رأي، تعليق، تحية، مجاملة، مشكلة من غير سؤال محدد -> isHelp: false
2. لازم الرد يتعامل فعلاً مع نفس السؤال ده بالذات، مش موضوع تاني حتى لو قريب منه
3. لو الرد إجابة نهائية بس من غير أي شرح أو تفسير (زي "D" أو "45" أو "أيوه"/"لأ" بدون توضيح) -> isHelp: false
4. ردود زي "تمام" / "ماشي" / "ok" / رموز تعبيرية بس / "مش عارف" / "حاول تسأل حد تاني" -> isHelp: false
5. لو الرد سؤال إضافي أو استفسار (مش شرح) -> isHelp: false
6. لو الرد فيه شرح لكنه سطحي، ناقص، غير مفهوم، أو غلط علميًا/منطقيًا -> isHelp: false
7. لو الرد شرح مختصر لكن صحيح ومفهوم وموضح ليه/إزاي -> isHelp: true, quality: 2
8. لو الرد شرح شامل ومفصل وصحيح تمامًا وسهل الفهم -> isHelp: true, quality: 3
9. لو مش متأكد إن الشرح صحيح ومفهوم فعلاً، اختار isHelp: false
...
المساعدة الحقيقية حاجة واحدة بس: **تفسير/شرح إجابة سؤال بشكل صحيح ومفهوم فعلاً** — مش مجرد إجابة نهائية من غير شرح، ومش معلومة عامة، ومش شرح سطحي أو غلط.

كن متشددًا جدًا جدًا. لما تشك، اختار isHelp: false.
...
قواعد:
- لو الرسالة كلام عادي، دردشة، رأي، تعليق، مجاملة، معلومة عامة -> isHelp: false
- لو الرسالة إجابة نهائية بس من غير شرح (زي حرف/رقم/كلمة واحدة بدون توضيح) -> isHelp: false
- لو الرسالة فيها شرح سطحي، ناقص، غير مفهوم، أو غلط -> isHelp: false
- لو الرسالة فعلاً بتفسر/بتشرح إجابة سؤال بشكل صحيح وواضح ومفهوم -> isHelp: true
